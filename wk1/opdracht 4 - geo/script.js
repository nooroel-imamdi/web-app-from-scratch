...
(function(){
    ...
    var availability = {
        ...
        init: function(){
            ...
            ET.addListener(config, _start_interval);
            ET.addListener(config, function(){debug_message('GPS is niet beschikbaar.')});

            (geo_position_js.init())?ET.fire(config):ET.fire(config);
        },
        ...
        startInterval: function(events){
            ...
            ET.addListener(config, _check_locations);
        },
